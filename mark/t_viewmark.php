  ...
  <div class="content content_inside">
    <div class="header_text">
      ...
      <div class="top_common_bar">
      	<div class="obj_left">
        	<select onChange="getClassData(this.value,'t_viewmark');" class="form-control" name="ddlClass">
        ...
        <div class="obj_right">
        	<a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>mark/t_addmark.php"><i class="fa fa-plus"></i>&nbsp;Add Mark</a>&nbsp;<a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>t_dashboard.php"><i class="fa"></i>Dashboard</a></div>
        </div>
      </div>
    ...
    <div class="list" style="width:100%; height:480px; overflow:auto;">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td align="center"><a data-toggle="tooltip" data-placement="top" title="View Mark" class="btn btn-success btn-xs mrg" href="<?php echo WEB_URL;?>mark/t_mark_details.php?sid=<?php echo $row['s_id']; ?>&cid=<?php echo $_GET['cid']; ?>"><i class="fa fa-eye"></i>&nbsp;&nbsp;Mark Details</a></td>
        </tr>
