...
if(isset($_GET['id']) && $_GET['id'] != '' && $_GET['id'] > 0){
	$sqlx= "DELETE FROM `tbl_student_attendance` WHERE aid = ".$_GET['id'];
	mysql_query($sqlx,$link); 
	$msg = 'Delete Student Attendance Successfully';
	$token = 'block';
}
?>
  <?php
if(isset($_GET['m']) && $_GET['m'] == 'i'){
	$msg = 'Added Student Attendance Successfully';
	$token = 'block';
}

if(isset($_GET['m']) && $_GET['m'] == 'u'){
	$msg = 'Update Student Attendance Successfully';
	$token = 'block';
}
*/
?>
  ...
  <div class="content content_inside">
    <div class="header_text">
      ...
      <div class="top_common_bar">
      	<div class="obj_left">
        	<select onChange="getClassData(this.value,'t_viewattendance');" class="form-control" name="ddlClass">
        ...
        <div class="obj_right">
        	<a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>Attendance/t_addattendance.php"><i class="fa fa-plus"></i>&nbsp;Add Attendance</a>&nbsp;<a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>t_dashboard.php"><i class="fa"></i>Dashboard</a></div>
        </div>
      </div>
    ...
    <div class="list" style="width:100%; height:480px; overflow:auto;">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a data-toggle="tooltip" data-placement="top" title="View Attendance" class="btn btn-success btn-xs mrg" href="<?php echo WEB_URL;?>attendance/t_attendance_details.php?sid=<?php echo $row['s_id']; ?>&cid=<?php echo $_GET['cid']; ?>&mval=<?php echo $mval ; ?>"><i class="fa fa-eye"></i></a></td>
        </tr>
