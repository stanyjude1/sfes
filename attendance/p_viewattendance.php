    ...
    <div class="list" style="width:100%; height:480px; overflow:auto;">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a data-toggle="tooltip" data-placement="top" title="View Attendance" class="btn btn-success btn-xs mrg" href="<?php echo WEB_URL;?>attendance/p_attendance_details.php?sid=<?php echo $row['s_id']; ?>&cid=<?php echo $row['c_id']; ?>&mval=<?php echo $mval ; ?>"><i class="fa fa-eye"></i></a></td>
        </tr>
