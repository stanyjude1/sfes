...
<div class="content content_inside">
  <div class="header_text">
    ...
    <div class="top_common_bar">
      <div class="obj_right"><a class="btn_save" href="<?php echo WEB_URL; ?>settings/setting.php">Setting</a></div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-12">
      <form action="" method="post" enctype="multipart/form-data" accept-charset="utf-8">
        ...
        <div class="form-group">
          ...
          <div class="row">
            <div class="col-xs-1" style="vertical-align:middle !important ;">
              <input type="radio" name="radioStatus" <?php if($b_status == 'enable'){echo 'checked=checked';}?> value="enable" id="radioStatusEnable" class="form-control"/>&nbsp;<label for="radioStatusEnable">Enable</label>
            </div>
            <div class="col-xs-1" style="vertical-align:middle !important ;">
              <input type="radio" name="radioStatus" <?php if($b_status == 'disable'){echo 'checked=checked';}?> value="disable" id="radioStatusDisable" class="form-control"/>&nbsp;<label for="radioStatusDisable">Disable</label>
            </div>
          </div>
        </div>
        <div class="form-group pull-right">
          ...
          &nbsp;
          <input type="reset" onClick="javascript:window.location.href='<?php echo WEB_URL; ?>settings/branch_setup.php';" name="btnReset" id="btnReset" value="Reset" class="btn btn-primary"/>
        </div>
      ...
      <table class="table common_sakotable table-bordered table-striped dt-responsive">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a class="btn btn-primary btn-xs mrg" data-toggle="tooltip" title="Edit Me" href="<?php echo WEB_URL;?>settings/branch_setup.php?spid=<?php echo $row['bid']; ?>" data-original-title="Edit"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;<a class="btn btn-danger btn-xs mrg" data-toggle="tooltip" title="Delete Me" onclick=deleteMe("<?php echo WEB_URL;?>settings/branch_setup.php?delid=<?php echo $row['bid'];?>"); href="javascript:void(0);" data-original-title="Delete"><i class="fa fa-trash-o"></i></a></td>
          </tr>
