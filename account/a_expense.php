...
$form_url = WEB_URL . "account/a_expense.php";
$id="";
$hdnid="0";
...
if(isset($_POST['txtExIssue'])){
	...
	mysql_close($link);
	$redirect_url = WEB_URL . 'account/a_expense_list.php?m=i';
	...
	mysql_query($sql,$link);
	mysql_close($link);
	$redirect_url = WEB_URL . 'account/a_expense_list.php?m=u';
	header('Location: ' . $redirect_url);
	die();
}
...
if(isset($_GET['id']) && $_GET['id'] != ''){
	...
	while($row = mysql_fetch_array($result)){
		...
		$form_url = WEB_URL . "account/a_expense.php?id=".$_GET['id'];
	}
...
<div class="content">
  ...
  <div class="main_content">
    <div class="main_content_left">
      ...
      <div class="my_button"><a class="btn btn_back btn-success" href="<?php echo WEB_URL; ?>account/a_expense_list.php">Expense List</a></div>
    </div>
    <div class="frmstyle">
