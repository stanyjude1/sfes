...
<div class="content content_inside">
  <div class="header_text">
	...
	<div class="obj_left">
        <select id="ddlClass" onChange="getRollClass(this.value,'a_transport_fee_list');" class="form-control" name="ddlClass">
      ...
      <div class="obj_left">
        <select onChange="getRollData(this.value,'a_transport_fee_list');" class="form-control" name="ddlRoll" id="ddlRoll">
      ...
      <div class="obj_right" style="padding-right:10px !important;"><a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>account/a_add_transport_fee.php"><i class="fa fa-plus"></i>&nbsp;Transport Fee</a>&nbsp;<a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>account/a_account.php"><i class="fa"></i>Account</a></div>
    </div>
  </div>
...
<script type="text/javascript">
  function deleteTransport(Id){
	...
	if(iAnswer){
		window.location = 'a_transport_fee_list.php?id=' + Id;
	}
  }
  </script>
