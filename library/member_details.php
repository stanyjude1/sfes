...
$id = '';
$result = mysql_query("Select *,s.s_name,s.s_image,c.c_name from tbl_library_member lm inner join tbl_add_student s on lm.sid = s.s_id inner join tbl_add_class c on lm.cid = c.c_id where lm.lmid='".$_GET['id']."'",$link);
...
?>
  ...
  <div style="padding:10px;">
    ...
    <div style="padding:10px;">
      ...
      <table class="table common_sakotable table-bordered table-striped dt-responsive">
        ...
        <tbody>
          <?php
	   /*echo "Select *,m.lmid from tbl_book_issue i inner join tbl_library_member m on m.lmid = i.lid where i.lid='".$_GET['id']."' order by i.issue_id asc";
	   die();*/
  ...
  <div style="padding:10px;" align="center"><a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>library/memberlist.php"><i class="fa fa-list"></i>&nbsp;Member List</a>&nbsp;&nbsp;<a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>dashboard.php"><i class="fa fa-home"></i>&nbsp;Dashboard</a></div>
</div>
