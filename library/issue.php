...
if(isset($_POST['txtLibraryID'])){
	if(isset($_POST['hdn']) && $_POST['hdn'] == '0'){
	  ...
	  mysql_close($link);
	  $redirect_url = WEB_URL . 'library/issuelist.php?m=i';
	...
	$sql = "UPDATE `tbl_book_issue` SET `lid`='".$_POST['txtLibraryID']."',`bname`='".$_POST['ddlBookName']."',`issue_date`='".$_POST['txtIssueDate']."',`return_date`='".$_POST['txtReturnDate']."',`fine`='".$_POST['txtFine']."',`note`='".$_POST['txtNote']."' WHERE issue_id='".$_GET['id']."'";
	  mysql_query($sql,$link);
	  mysql_close($link);
	  $redirect_url = WEB_URL . 'library/issuelist.php?m=u';
	  header('Location: ' . $redirect_url);
	  die();
}
  ...
  <div class="content">
    ...
    <div class="main_content">
      <div class="main_content_left">
        ...
        <div class="my_button"><a class="btn btn_back btn-success" href="<?php echo WEB_URL; ?>library/issuelist.php">Issue Book List</a></div>
      </div>
      <div class="frmstyle">
