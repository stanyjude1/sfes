...
?>
  ...
  <div class="content content_inside">
    <div class="header_text">
      ...
      <div class="top_common_bar">
      	<div class="obj_left">
        	<select onChange="getClassData(this.value,'l_memberlist');" class="form-control" name="ddlClass">
        ...
        <div class="obj_right">
        	<a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>l_dashboard.php"><i class="fa"></i>Back</a></div>
        </div>
      </div>
  ...
  function deleteMember(id,cid){
	...
	if(iAnswer){
		window.location = 'l_memberlist.php?id=' + id + '&cid=' + cid;
	}
  }
  </script>
