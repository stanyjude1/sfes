...
if(isset($_GET['id']) && $_GET['id'] != '' && $_GET['id'] > 0){
	$sqlx= "DELETE FROM `tbl_hostel_category` WHERE category_id = ".$_GET['id'];
...
<div class="content content_inside">
  <div class="header_text">
    ...
    <div class="top_common_bar">
      <div class="obj_right" style="padding-right:10px !important;"><a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>hostel/a_add_category.php"><i class="fa fa-plus"></i>&nbsp;Add Category</a>&nbsp;<a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>hostel/a_hostel.php"><i class="fa"></i>Hostel Dashboard</a></div>
    </div>
    </div>
    ...
    <table class="table sakotable table-bordered table-striped dt-responsive">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a title="Edit" data-toggle="tooltip" data-placement="top" class="btn btn-primary btn-xs mrg" href="<?php echo WEB_URL;?>hostel/a_add_category.php?id=<?php echo $row['category_id']; ?>"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;<a title="Delete" data-toggle="tooltip" data-placement="top" class="btn btn-danger btn-xs mrg" onClick="deleteCategory(<?php echo $row['category_id']; ?>);" href="javascript:void(0);"><i class="fa fa-trash-o"></i></a></td>
        </tr>
...
<script type="text/javascript">
  function deleteCategory(Id){
	...
	if(iAnswer){
		window.location = 'a_category_list.php?id=' + Id;
	}
  }
  </script>
