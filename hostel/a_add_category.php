...
if(isset($_POST['ddlCategoryName'])){
	if(isset($_POST['hdn']) && $_POST['hdn'] == '0'){
	  ...
	  mysql_close($link);
	  $redirect_url = WEB_URL . 'hostel/a_category_list.php?m=i';
	...
	$sql = "UPDATE `tbl_hostel_category` SET `hostel_id`='".$_POST['ddlCategoryName']."',`hostel_category`='".$_POST['ddlCategory']."',`hostel_fee`='".$_POST['txtFee']."',`hostel_note`='".$_POST['txtCNote']."' WHERE category_id='".$_GET['id']."'";
	  mysql_query($sql,$link);
	  mysql_close($link);
	  $redirect_url = WEB_URL . 'hostel/a_category_list.php?m=u';
	  header('Location: ' . $redirect_url);
	  die();
}
  ...
  <div class="content">
    ...
    <div class="main_content">
      <div class="main_content_left">
        ...
        <div class="my_button"><a class="btn btn_back btn-success" href="<?php echo WEB_URL; ?>hostel/a_hostel.php">Hostel Dashboard</a></div>
        <div class="my_button"><a class="btn btn_back btn-success" href="<?php echo WEB_URL; ?>hostel/a_category_list.php">Category List</a></div>
      </div>
      <div class="frmstyle">
