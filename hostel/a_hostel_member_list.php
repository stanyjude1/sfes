...
?>
  ...
  <div class="content content_inside">
    <div class="header_text">
      ...
      <div class="top_common_bar">
      	<div class="obj_left">
        	<select onChange="getClassData(this.value,'a_hostel_member_list');" class="form-control" name="ddlClass">
        ...
        <div class="obj_right">
        	<a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>hostel/a_hostel.php"><i class="fa"></i>Hostel Dashboard</a></div>
        </div>
      </div>
    ...
    <div class="list" style="width:100%;">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php if(isset($row['hmid']) && $row['hmid'] != ''){ ?><a data-toggle="tooltip" data-placement="top" title="View" class="btn btn-success btn-xs mrg" href="<?php echo WEB_URL;?>hostel/a_hostel_member_details.php?id=<?php echo $row['hmid']; ?>&cid=<?php echo $_GET['cid']; ?>"><i class="fa fa-eye"></i></a><?php } else {?><a data-toggle="tooltip" data-placement="top" title="Add Member" class="btn btn-success btn-xs mrg" href="<?php echo WEB_URL;?>hostel/a_add_hostel_member.php?sid=<?php echo $row['s_id']; ?>&cid=<?php echo $_GET['cid']; ?>"><i class="fa fa-plus"></i></a><?php }?>&nbsp;&nbsp;<?php if(isset($row['hmid']) && $row['hmid'] != ''){ ?><a title="Edit" data-toggle="tooltip" data-placement="top" class="btn btn-primary btn-xs mrg" href="<?php echo WEB_URL;?>hostel/a_add_hostel_member.php?id=<?php echo $row['hmid']; ?>&cid=<?php echo $row['cid']; ?>"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;<a title="Delete" data-toggle="tooltip" data-placement="top" class="btn btn-danger btn-xs mrg" onClick="deleteMember(<?php echo $row['hmid']; ?>,<?php echo $row['c_id']; ?>);" href="javascript:void(0);"><i class="fa fa-trash-o"></i></a><?php } else {?>&nbsp;&nbsp;<?php }?></td>
        </tr>
  ...
  function deleteMember(hid,cid){
	...
	if(iAnswer){
		window.location = 'a_hostel_member_list.php?id=' + hid + "&cid=" + cid ;
	}
  }
  </script>
