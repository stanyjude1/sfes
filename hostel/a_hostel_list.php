...
<div class="content content_inside">
  <div class="header_text">
    ...
    <div class="top_common_bar">
      <div class="obj_right" style="padding-right:10px !important;"><a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>hostel/a_add_hostel.php"><i class="fa fa-plus"></i>&nbsp;Add Hostel</a>&nbsp;<a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>hostel/a_hostel.php"><i class="fa"></i>Hostel Dashboard</a></div>
    </div>
    </div>
    ...
    <table class="table sakotable table-bordered table-striped dt-responsive">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a title="Edit" data-toggle="tooltip" data-placement="top" class="btn btn-primary btn-xs mrg" href="<?php echo WEB_URL;?>hostel/a_add_hostel.php?id=<?php echo $row['h_id']; ?>"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;<a title="Delete" data-toggle="tooltip" data-placement="top" class="btn btn-danger btn-xs mrg" onClick="deleteHostel(<?php echo $row['h_id']; ?>);" href="javascript:void(0);"><i class="fa fa-trash-o"></i></a></td>
        </tr>
...
<script type="text/javascript">
  function deleteHostel(Id){
	...
	if(iAnswer){
		window.location = 'a_hostel_list.php?id=' + Id;
	}
  }
  </script>
