...
?>
  ...
  <div class="content">
    ...
    <div align="center" style="width:88%;margin:0 auto;padding:0;">
      <div class="link_box">
        <div class="link_box_img dashboard_image"><a href="<?php echo WEB_URL; ?>examination/p_exam_date_list.php"><img height="80" width="80" src="<?php echo WEB_URL; ?>img/date.png"></a></div>
        <div class="link_box_text">Exam. Date</div>
      </div>
      <div class="link_box">
        <div class="link_box_img dashboard_image"><a href="<?php echo WEB_URL; ?>examination/p_exam_schedule_list.php"><img height="80" width="80" src="<?php echo WEB_URL; ?>img/schedule.png"></a></div>
