...
<div class="content content_inside">
  <div class="header_text">
    ...
    <div class="top_common_bar">
      <div class="obj_right" style="padding-right:10px !important;"><a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>transport/add_transport.php"><i class="fa fa-plus"></i>&nbsp;Add Transport</a>&nbsp;<a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>transport/transport.php"><i class="fa"></i>Transport</a></div>
    </div>
  </div>
    ...
    <table width="100%" align="center" class="table sakotable table-bordered table-striped dt-responsive">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td align="center"><a title="Edit" data-toggle="tooltip" data-placement="top" class="btn btn-warning btn-xs mrg" href="<?php echo WEB_URL;?>transport/add_transport.php?id=<?php echo $row['transport_id']; ?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;<a title="Delete" data-toggle="tooltip" data-placement="top" class="btn btn-danger btn-xs mrg" onClick="deleteTransport(<?php echo $row['transport_id']; ?>);" href="javascript:void(0);"><i class="fa fa-trash-o"></i></a></td>
        </tr>
...
<script type="text/javascript">
  function deleteTransport(Id){
	...
	if(iAnswer){
		window.location = 'transport_list.php?id=' + Id;
	}
  }
  </script>
