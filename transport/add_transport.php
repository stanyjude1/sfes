...
if(isset($_POST['txtTrpDestination'])){
	if(isset($_POST['hdn']) && $_POST['hdn'] == '0'){
	  ...
	  mysql_close($link);
	  $redirect_url = WEB_URL . 'transport/transport_list.php?m=i';
	...
	$sql = "UPDATE `tbl_add_transport` SET `destination`='".$_POST['txtTrpDestination']."',`vehicle`='".$_POST['txtTrpVehicle']."',`fare`='".$_POST['txtTrpFare']."',`note`='".$_POST['txtTrpNote']."' WHERE transport_id='".$_GET['id']."'";
	  ...
	  mysql_query($sql,$link);
	  mysql_close($link);
	  $redirect_url = WEB_URL . 'transport/transport_list.php?m=u';
	  header('Location: ' . $redirect_url);
	  die();
}
  ...
  <div class="content">
    ...
    <div class="main_content">
      <div class="main_content_left">
        ...
        <div class="my_button"><a class="btn btn_back btn-success" href="<?php echo WEB_URL; ?>transport/transport_list.php">Back To Transport List</a></div>
      </div>
      <div class="frmstyle">
