...
?>
  ...
  <div class="content content_inside">
    ...
    <div class="top_common_bar">
      <div class="obj_right" style="padding-right:10px !important;"><a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>transport/s_transport.php"><i class="fa"></i>Back</a></div>
    </div>
    </div>
