...
$form_url = WEB_URL . "notice/add_notice.php";
$id="";
$hdnid="0";
...
if(isset($_POST['txtTitle'])){
	if(isset($_POST['hdn']) && $_POST['hdn'] == '0'){
	  ...
	  mysql_close($link);
	  $redirect_url = WEB_URL . 'notice/notice_list.php?m=i';
	...
	$sql = "UPDATE `tbl_add_notice` SET `n_title`='".$_POST['txtTitle']."',`date`='".$_POST['txtDate']."',`permission`='".$_POST['txtPermission']."',`notice`='".$_POST['txtNotice']."' WHERE n_id='".$_GET['id']."'";
	  ...
	  mysql_query($sql,$link);
	  mysql_close($link);
	  $redirect_url = WEB_URL . 'notice/notice_list.php?m=u';
	  header('Location: ' . $redirect_url);
	  die();
}
...
if(isset($_GET['id']) && $_GET['id'] != ''){
	...
	while($row = mysql_fetch_array($result)){
		...
		$form_url = WEB_URL . "notice/add_notice.php?id=".$_GET['id'];
	}
...
<div class="content">
  ...
  <div class="main_content">
    <div class="main_content_left">
      ...
      <div class="my_button"><a class="btn btn_back btn-success" href="<?php echo WEB_URL; ?>notice/notice_list.php">Notice List</a></div>
    </div>
    <div class="frmstyle">
