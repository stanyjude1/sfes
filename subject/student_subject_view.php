...
<div class="content content_inside">
  <div class="header_text">
    <div class="header_text_left"><?php echo $_SESSION['objLogin']['s_name']?>&nbsp;Subject List</div>
    ...
    <table class="table common_sakotable_att table-bordered table-striped dt-responsive">
      ...
      <tbody>
        <?php
		  ...
		  $result = mysql_query("Select *, c.c_name, t.t_name from tbl_add_subject s INNER JOIN tbl_add_class c on c_id=sb_class_id inner join tbl_add_teacher t on 	teacher_id=sb_teacher_id where sb_class_id = '" . (int)$_SESSION['objLogin']['s_class_id'] . "' order by sb_id desc",$link);
		  }
		  else{
