...
?>
  ...
  <div style="padding:10px;" align="center"><a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>student/t_student_list.php?cid=<?php echo $_GET['cid']; ?>"><i class="fa fa-back"></i>&nbsp;Back To List</a></div>
</div>
