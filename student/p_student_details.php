...
?>
  ...
  <div style="padding:10px;">
    ...
    <div style="font-size:13px;text-align:left;" class="row">
      <div class="col-md-6">
        <div class="top_text_title_style">Guardian Information</div>
        <table class="table">
          <tr>
          ...
          <tr>
            ...
            <td><?php echo $row['p_religion'];?></td>
          </tr>
        </table>
      </div>
      <div class="col-md-6">
        <div class="exam_table_style">Student Information</div>
        <table class="table">
          <tr>
  ...
  <div style="padding:10px;" align="center"><a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>student/p_student_list.php?cid=<?php echo $_GET['cid']; ?>"><i class="fa fa-home"></i>&nbsp;Back</a></div>
</div>
